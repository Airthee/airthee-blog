...
const Post: FunctionComponent<PostProps> = ({ postData }) => {
  ...
  const shareSection = (
    <div className={utilStyles.alignCenter}>
      <FacebookShareButton url={postUrl} className={utilStyles.mx10}>
        <FacebookIcon {...shareIconProps} />
      </FacebookShareButton>
      <TwitterShareButton url={postUrl} className={utilStyles.mx10}>
        <TwitterIcon {...shareIconProps} />
      </TwitterShareButton>
      <LinkedinShareButton url={postUrl} className={utilStyles.mx10}>
        <LinkedinIcon {...shareIconProps} />
      </LinkedinShareButton>
      <EmailShareButton url={postUrl} className={utilStyles.mx10}>
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://blog.airthee.com/posts/${postData.id}`}
        />
